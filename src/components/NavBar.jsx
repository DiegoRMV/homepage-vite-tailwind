	...
	return (
		<nav>
			<div className="flex place-content-between items-center">
				...
				<ul className="hidden sm:flex sm:w-[438px] sm:place-content-between sm:text-[18px] text-[16px] sm:items-center">
					<li>
						<a
							href="#home"
							className="font-semibold hover:text-gray-600  dark:text-white"
						>
							Home
						</a>
					</li>
			...
			{open && (
				<div className="md:hidden">
					<div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 text-center">
						<a
							href="#home"
							className="block p-2 dark:hover:text-gray-300 hover:text-gray-600 dark:text-white"
						>
							Home
						</a>
						<a
						...
						<div className="inline-flex p-2 justify-center">{<DarkMode />}</div>
					</div>
				</div>
			)}
		</nav>
